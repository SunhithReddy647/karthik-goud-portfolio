    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          <button
            onClick={onClose}
            className="absolute -top-12 right-0 text-white hover:text-[#FF0080] transition-colors"
          >
          ...
          />
          <h3 className="text-white text-2xl font-bold mt-4 text-center" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
            {title}
          </h3>
        </motion.div>
      </motion.div>
