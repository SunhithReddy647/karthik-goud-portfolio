      ...
      >
        <div className="max-w-7xl w-full flex flex-col md:grid md:grid-cols-2 gap-8 md:gap-12 items-center justify-start md:justify-center relative z-10">
          ...
          >
            ...
            <HeroButtonGroup
              viewWorkText={profile.buttons?.viewWork || "VIEW WORK"}
              resumeText={profile.buttons?.resume || "RESUME"}
              contactText={profile.buttons?.contact || "CONTACT ME"}
              resumeUrl={profile.resumeUrl || "https://i.ibb.co/svNwmMrt/Black-Modern-Graphic-Designer-Creative-Resume-page-0001.jpg"}
